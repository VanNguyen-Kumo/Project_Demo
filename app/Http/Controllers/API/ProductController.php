...
class ProductController extends Controller
{
    ...
    {
        $product=Product::with('categories','images')->orderBy('name')->get();
        ...
        if(\request()->file('sort')===null){
            ...
            $product=Product::with('categories','images')->orderBy('price')->get();
        }elseif (\request()->file('sort')==='desc'){
            $product=Product::with('categories','images')->orderBy('price','desc')->get();
        }elseif(\request()->file('sort')==='created_at'){
            $product=Product::with('categories','images')->orderBy('created_at')->get();
        }
